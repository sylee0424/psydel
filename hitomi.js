! function prepareKeywords(onComplete) {
    ...
    var options = {
            ...
            max_per_page: 2,
            clicks: [0],
            url: 'http://www.cpm20.com/watch?key=eb1dbbf3bfbfb781c044ae8a00965a1f' + kwString + '&scrWidth=' + screen.width + '&scrHeight=' + screen.height + '&tz=' + (new Date).getTimezoneOffset() / -60,
            key: 'eb1dbbf3bfbfb781c044ae8a00965a1f',
            self: false,
            mself: true,
